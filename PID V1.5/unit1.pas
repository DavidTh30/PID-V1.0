  ...
  begin
   ...
   try
     ...
     try
       ...
       writeln(fileout, 'integral_Min='+FormatFloat('0.000',integral_Min)+',-,-,-,-');
       writeln(fileout, 'integral_Max='+FormatFloat('0.000',integral_Max)+',-,-,-,-');
       writeln(fileout, 'output_Min='+FormatFloat('0.000',output_Min)+',-,-,-,-');
       writeln(fileout, 'output_Max='+FormatFloat('0.000',output_Max)+',-,-,-,-');
       writeln(fileout, 'Filtter='+FormatFloat('0.000',Tau)+',-,-,-,-');
...
var
  Tempo:double;
begin
  if TryStrToFloat(Edit10.Text,Tempo) then
    begin
      output_Min:=StrToFloat(Edit10.Text);
      Edit10.Text:=FormatFloat('0.000',output_Min);
      output_Min:=StrToFloat(Edit10.Text);
    end
  else
    Edit10.Text:=FormatFloat('0.000',output_Min);
...
var
  Tempo:double;
begin
  if TryStrToFloat(Edit6.Text,Tempo) then
    begin
      Tau:=StrToFloat(Edit6.Text);
      Edit6.Text:=FormatFloat('0.000',Tau);
      Tau:=StrToFloat(Edit6.Text);
    end
  else
    Edit6.Text:=FormatFloat('0.000',Tau);
...
var
  Tempo:double;
begin
  if TryStrToFloat(Edit7.Text,Tempo) then
    begin
      integral_Max:=StrToFloat(Edit7.Text);
      Edit7.Text:=FormatFloat('0.000',integral_Max);
      integral_Max:=StrToFloat(Edit7.Text);
    end
  else
    Edit7.Text:=FormatFloat('0.000',integral_Max);
...
var
  Tempo:double;
begin
  if TryStrToFloat(Edit8.Text,Tempo) then
    begin
      integral_Min:=StrToFloat(Edit8.Text);
      Edit8.Text:=FormatFloat('0.000',integral_Min);
      integral_Min:=StrToFloat(Edit8.Text);
    end
  else
    Edit8.Text:=FormatFloat('0.000',integral_Min);
...
var
  Tempo:double;
begin
  if TryStrToFloat(Edit9.Text,Tempo) then
    begin
      output_Max:=StrToFloat(Edit9.Text);
      Edit9.Text:=FormatFloat('0.000',output_Max);
      output_Max:=StrToFloat(Edit9.Text);
    end
  else
    Edit9.Text:=FormatFloat('0.000',output_Max);
...
begin
  ...
  if (integral < integral_Min) then integral:=integral_Min;

  output:=(kp*proportional)+(ki*integral)+(kd*derivative);

  if output > output_Max then output:=output_Max;
  if output < output_Min then output:=output_Min;
  ...
  begin
    ...
    Form2.Label23.Caption:=FormatFloat('0.00000',output)+'=('+FormatFloat('0.000',kp)+'*'+FormatFloat('0.000',error_)+')+('+FormatFloat('0.000',ki)+'*'+FormatFloat('0.000',integral)+')+('+FormatFloat('0.000',kd)+'*'+FormatFloat('0.000',derivative)+')+0';
  end;
...
procedure TForm1.LostTimerTimer(Sender: TObject);
begin
...
begin
  ...
  error_:= setpoint-input;
  proportional:=kp* error_;
  integral:= integral+((ki*dt*(error_+previous_error))/2);
  if (integral > integral_Max) then integral:=integral_Max;
  if (integral < integral_Min) then integral:=integral_Min;

  derivative:= -((2*kd*(error_-previous_error))+(((2*Tau)-dt)*derivative))/((2*Tau)+dt);

  previous_error:=error_;

  output:=proportional+integral+derivative+0;
